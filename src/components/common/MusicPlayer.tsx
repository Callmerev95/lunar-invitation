...
export const MusicPlayer: React.FC<MusicPlayerProps> = ({
  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed bottom-6 right-6 z-50 items-center gap-2 bg-white/90 rounded-full shadow-elegant px-4 py-3 w-72">
        {/* Compact song info */}
        ...
        <button
          ...
          aria-label={isMuted ? "Unmute audio" : "Mute audio"}
          title={isMuted ? "Unmute" : "Mute"}
          className="shrink-0 text-[#D4AF88] hover:text-[#8B4F6F] p-1 disabled:opacity-50"
        >
